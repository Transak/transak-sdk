...
export const WebAppUrls = {
  ...
  [Environments.STAGING_ORDERS_NOT_LOGGED_IN]: 'https://global-stg.transak.com/login/email',
  [Environments.PRODUCTION_ORDERS_NOT_LOGGED_IN]: 'https://global.transak.com/login/email',
};
